...
This workspace is an operator surface for SocialPredict PR #581 governance and verification.
As of 2026-03-29, PR #581 head is `94231f1d5f49c564d1a99c0135456d92101ed8f0`
and local work tracks `socialpredict` branch `pilot/pr581-backend-api-20260329`.
